...
header("HANK Teaser: Heterogeneity & Policy Transmission", "Two-type households: Hand-to-Mouth vs Savers")
...
params = HANKTeaserParams(lam_htm=lam, mpc_htm=mpc_h, mpc_saver=mpc_s, ir_elast_saver=ir_el, multiplier=mult)
...
st.markdown("**Takeaway:** Higher λ (more HtM) → stronger income-driven transmission; stronger saver interest elasticity → bigger response to rate cuts/raises. This is the core idea behind HANK relative to representative-agent NK.")